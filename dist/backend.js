...
module.exports = app => {
  const routes = [
    ...
    // test
    { method: 'post', path: 'todo/uploadInner', controller: todo },
...
const todo = __webpack_require__(12);
  ...
  class Version extends app.Service {
    ...
    async init(options) {
      if (options.version === 1) {
        ...
        await this.ctx.meta.role.addRoleRightBatch({ atomClassName: 'todo', roleRights });
      }
    }
...
const todo = __webpack_require__(14);
